...
var puntos = document.getElementsByClassName("ficha");
//console.log(puntos);
var contadorblanco = 0;
var contadornegro = 12;
...
function eliminateCheck(indexx){
	...
	if(x.color == "white"){
		puntos[contadorblanco].innerHTML += '<div class="rojo"></div>'
		contadorblanco = contadorblanco + 1;
	}
	else{
		puntos[contadornegro].innerHTML += '<div class="negro"></div>'
...
function changeTurns(ckc){
	if(ckc.color=="white"){
		...
		//alert("Turno del jugador negro")
	}
	else{
		the_checker = w_checker;
		//alert("Turno del jugador rojo")
	}
 }
